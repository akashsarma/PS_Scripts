...
$KMSDB = "CCJAZZ_KMS"
$WCFSSLCert = "wcf.uat.cc-pod3.marcusinfra.nimbus.gs.com"
$CoreCreditSSLCert = "corecredit.uat.cc-pod3.marcusinfra.nimbus.gs.com"
$CoreIssueSSLCert = "ci.uat.cc-pod3.marcusinfra.nimbus.gs.com"
$ServicesSSLCert = "service.uat.cc-pod3.marcusinfra.nimbus.gs.com"
$ReportServicesSSLCert = "report.uat.cc-pod3.marcusinfra.nimbus.gs.com"
...
$PlatPIIHubEnv = "PlatPIIHubEnv=Testing"
$PlatPIIHubTokenEnv = "PlatPIIHubTokenEnv=Testing" 
$PlatAutoRewardRedeem = "PlatAutoRewardRedeem=Testing"
$RelaxIssueStatusCheckForActivation = "RelaxIssueStatusCheckForActivation=TEST"
$TokenRefreshCall = "TokenRefreshCall=1"
$TLS12Required = ""
$KMS = "cckmse1uat1 cckmse1uat2"
$MIPTestRequired = "NO"
$MIPEndPoint = "uat.hsm.infra.marcus.com"
$MIPPort = "1500"
$HSMEndPoint = "uat.hsm.infra.marcus.com"
$HSMPort = "1500"
