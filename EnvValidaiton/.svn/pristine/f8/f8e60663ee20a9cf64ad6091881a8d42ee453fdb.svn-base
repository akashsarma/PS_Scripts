...
$KMSDB = "CCJAZZ_KMS"
$WCFSSLCert = "wcf.mock.cc-pod3.marcusinfra.nimbus.gs.com"
$CoreCreditSSLCert = "corecredit.mock.cc-pod3.marcusinfra.nimbus.gs.com"
$CoreIssueSSLCert = "ci.mock.cc-pod3.marcusinfra.nimbus.gs.com"
$ServicesSSLCert = "service.mock.cc-pod3.marcusinfra.nimbus.gs.com"
$ReportServicesSSLCert = "report.mock.cc-pod3.marcusinfra.nimbus.gs.com"
################################################SetupCI and CoreAuthSetup Variable########################################
$SCALE_SERVER_HOST = "CCWEBE1MOCKB1"
...
$TLS12Required = "NO"
$KMS = "cckmse1mockb1 cckmse1mockb2"
$MIPTestRequired = "NO"
$MIPEndPoint = "mock.hsm.infra.marcus.com"
$MIPPort = "1500"
$HSMEndPoint = "mock.hsm.infra.marcus.com"
$HSMPort = "1500"
#############################################ICA AND GSI Number Value In All Environments#################################
# ICA Number in PLAT All Environments=019800 | All JAZZ Environment=021190
# GSINumber Number in PLAT-DEV, QA UAT, DEV and PROD=19805 | PATUAT=525363 | PATQA=547895 | All JAZZ Environment=31190
#############################################SetupCI and CoreAuthSetup Variable###########################################
$ICANumber = "021190"
$GSINumber = "31190"
