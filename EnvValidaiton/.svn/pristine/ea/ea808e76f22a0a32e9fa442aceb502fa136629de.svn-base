...
$KMSDB = "CCGS_KMS"
$WCFSSLCert = "wcf.patuat.cc-pod2.marcusinfra.nimbus.gs.com"
$CoreCreditSSLCert = "corecredit.patuat.cc-pod2.marcusinfra.nimbus.gs.com"
$CoreIssueSSLCert = "ci.patuat.cc-pod2.marcusinfra.nimbus.gs.com"
$ServicesSSLCert = "service.patuat.cc-pod2.marcusinfra.nimbus.gs.com"
$ReportServicesSSLCert = "report.patuat.cc-pod2.marcusinfra.nimbus.gs.com"
################################################SetupCI and CoreAuthSetup Variable########################################
$SCALE_SERVER_HOST = "CCWEBE1PATUATB1"
$ExperianSetup = "ExperianSetup=Testing"
$Enviroment = "Enviroment=Testing"
$Environment = "PLAT"
$emPassword = "rd@PRODr03CC"
$PlatPIIHubEnv = "PlatPIIHubEnv=PATUAT"
$PlatPIIHubTokenEnv = "PlatPIIHubTokenEnv=PATUAT" 
$PlatAutoRewardRedeem = "PlatAutoRewardRedeem=PATUAT"
$RelaxIssueStatusCheckForActivation = "RelaxIssueStatusCheckForActivation=TEST"
$TokenRefreshCall = "TokenRefreshCall=1"
$TLS12Required = "YES"
$KMS = "cckmse1patuatb1 cckmse1patuatb2"
$MIPTestRequired = "NO"
$MIPEndPoint = "patuat.hsm.infra.marcus.com"
$MIPPort = "1500"
$HSMEndPoint = "patuat.hsm.infra.marcus.com"
$HSMPort = "1500"
