...
$KMSDB = "CCGS_KMS"
$WCFSSLCert = "wcf.dev.cc-pod2.marcusinfra.nimbus.gs.com"
$CoreCreditSSLCert = "corecredit.dev.cc-pod2.marcusinfra.nimbus.gs.com"
$CoreIssueSSLCert = "ci.dev.cc-pod2.marcusinfra.nimbus.gs.com"
$ServicesSSLCert = "service.dev.cc-pod2.marcusinfra.nimbus.gs.com"
$ReportServicesSSLCert = "report.dev.cc-pod2.marcusinfra.nimbus.gs.com"
################################################SetupCI and CoreAuthSetup Variable########################################
$SCALE_SERVER_HOST = "CCWEBE1DEVB1"
$ExperianSetup = "ExperianSetup=Testing"
$Environment = "PLAT"
$emPassword = "rd@PRODr03CC"
$Enviroment = "Enviroment=Testing"
$PlatPIIHubEnv = "PlatPIIHubEnv=DEV"
$PlatPIIHubTokenEnv = "PlatPIIHubTokenEnv=DEV" 
$PlatAutoRewardRedeem = "PlatAutoRewardRedeem=DEV"
$RelaxIssueStatusCheckForActivation = "RelaxIssueStatusCheckForActivation=TEST"
$TokenRefreshCall = "TokenRefreshCall=0"
$TLS12Required = "NO"
$KMS = "CCKMSE1DEVB1 CCKMSE1DEVB2"
$MIPTestRequired = "NO"
$MIPEndPoint = "dev.hsm.infra.marcus.com"
$MIPPort = "1500"
$HSMEndPoint = "dev.hsm.infra.marcus.com"
$HSMPort = "1500"
#############################################ICA AND GSI Number Value In All Environments#################################
# ICA Number in PLAT All Environments=019800 | All PLAT Environment=021190
# GSINumber Number in PLAT-DEV, QA UAT, dev and PROD=19805 | PATUAT=525363 | PATQA=547895 | All PLAT Environment=31190
#############################################SetupCI and CoreAuthSetup Variable###########################################
$ICANumber = "019800"
$GSINumber = "19805"
